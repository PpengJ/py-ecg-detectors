...
import ecgtemplates
import unittest
import Unit_test_data.arrays as data
...
class Testecgdetectors(unittest.TestCase):
    ...
    def test_two_average_detector(self):
        unfiltered_ecg_dat = data.two_average_detector_test_ecg
        unfiltered_ecg = unfiltered_ecg_dat[:, 0]
        example_answer_dat1 = data.two_average_detector_test_ecg_answer
    ...
    def test_matched_filter_detector(self):
        unfiltered_ecg_dat = data.matched_filter_detector_test_ecg
        unfiltered_ecg = unfiltered_ecg_dat[:, 0]
        example_answer_dat1 = data.matched_filter_detector_test_ecg_answer
        example_answer_dat2 = example_answer_dat1.ravel()
        example_answer = example_answer_dat2.astype(int)
    ...
    def test_swt_detector(self):
        unfiltered_ecg_dat = data.swt_detector_test_ecg
        unfiltered_ecg = unfiltered_ecg_dat[:, 0]
        example_answer_dat1 = data.swt_detector_test_ecg_answer
        example_answer_dat2 = example_answer_dat1.ravel()
        example_answer = example_answer_dat2.astype(int)
    ...
    def test_engzee_detector(self):
        unfiltered_ecg_dat = data.engzee_detector_test_ecg
        unfiltered_ecg = unfiltered_ecg_dat[:, 0]

        example_answer_dat1 = data.engzee_detector_test_ecg_answer
        example_answer_dat2 = example_answer_dat1.ravel()
        example_answer = example_answer_dat2.astype(int)
    ...
    def test_christov_detector(self):
        unfiltered_ecg_dat = data.christov_detector_test_ecg
        unfiltered_ecg = unfiltered_ecg_dat[:, 0]

        example_answer_dat1 = data.christov_detector_test_ecg_answer
        example_answer_dat2 = example_answer_dat1.ravel()
        example_answer = example_answer_dat2.astype(int)
    ...
    def test_hamilton_detector(self):
        unfiltered_ecg_dat = data.hamilton_detector_test_ecg
        unfiltered_ecg = unfiltered_ecg_dat[:, 0]

        example_answer_dat1 = data.hamilton_detector_test_ecg_answer
        example_answer_dat2 = example_answer_dat1.ravel()
        example_answer = example_answer_dat2.astype(int)
    ...
    def test_pan_tompkins_detector(self):
        unfiltered_ecg_dat = data.pan_tompkins_detector_test_ecg
        unfiltered_ecg = unfiltered_ecg_dat[:, 0]

        example_answer_dat1 = data.pan_tompkins_detector_test_ecg_answer
        example_answer_dat2 = example_answer_dat1.ravel()
        example_answer = example_answer_dat2.astype(int)
    ...
    def test_wqrs_detector(self):
        unfiltered_ecg_dat = data.wqrs_detector_test_ecg
        unfiltered_ecg = unfiltered_ecg_dat[:, 0]

        example_answer_dat1 = data.wqrs_detector_test_ecg_answer
        example_answer_dat2 = example_answer_dat1.ravel()
        example_answer = example_answer_dat2.astype(int)
